...
・The basic Exception is Error, and ZeroDivisionError inherits Error and override its method.
...
・LabelOutput -> actually display warnign messages and user output</br>
...
・In terms of module, there are app.py, components.py, and exceptions.py, and each organize codes with a different aim.</br>
...
・ZeroDivisionError overides *warning()* of Error and rewrite a return value.</br>
...
### ▼Tests
・The tests were aimed at three courses:
